...
<head>
  ...
  <!-- Font Awesome -->
  <link rel="stylesheet" href="<?php echo base_url("assets/backend/plugins/fontawesome/css/font-awesome.min.css"); ?>">
  <!-- Ionicons -->
  <link rel="stylesheet" href="<?php echo base_url("assets/backend/plugins/ionicons/css/ionicons.min.css"); ?>">
...
<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu">
        ...
        <li <?php echo $active == "picture" ? 'class="active"' : '' ?>>
          <a href="<?php echo site_url('picture'); ?>"><i class="fa fa-camera"></i> <span>Picture</span></a>
        </li>
        <li <?php echo $active == "article" ? 'class="active"' : '' ?>>
          <a href="<?php echo site_url('article'); ?>"><i class="fa fa-pencil-square-o"></i> <span>Article</span></a>
        </li>
        <li <?php echo $active == "comment" ? 'class="active"' : '' ?>>
          <a href="<?php echo site_url('comment'); ?>"><i class="fa fa-comments"></i> <span>Comment</span></a>
        </li>
     </ul>
  </section>
  <!-- /.sidebar -->
  ...
  <div class="content-wrapper" style="background: #ffffff">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo site_url($active); ?>"><?php echo $active; ?></a></li>
      </ol>
    </section>
